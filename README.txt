...
The 3D protein structures are generated with the help of Google's AlphaFold v2 (Link: https://github.com/google-deepmind/alphafold). The predicted thermostability heatmap is generated with the help of Dieckhaus, Brocidiacono, Randolph and Kuhlman's ThermoMPNN (Link: https://github.com/Kuhlman-Lab/ThermoMPNN) model. The modeling done to support this project in developing the ThermoMPNN+ model is discussed at the end of this README, and also leverages ThermoMPNN in combination with Meta's ESM-2 model (Link: https://github.com/facebookresearch/esm).
...
cd CODE
Execute the following command from the root directory to run the web app
python CODE/DVA_UI/app.py
Follow the instructions in the terminal to view the web app in your browser
...
Fireprot Data(Link: https://zenodo.org/records/8169289)
...
We included additional external data from Chris Deotte's research (Link: https://www.kaggle.com/code/cdeotte/xgboost-5000-mutations-200-pdb-files-lb-0-410#Create-Submission-CSV) on Novozymes in the downloaded_csv folder.
...
Our models leverage embeddings from the ThermoMPNN (Link: https://github.com/Kuhlman-Lab/ThermoMPNN) framework. The original ThermoMPNN model was crucial for generating training and validation datasets for protein data.
